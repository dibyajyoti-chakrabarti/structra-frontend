    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#f5f5f5]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 lg:pt-20 pb-8 sm:pb-12">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg text-[#a3a3a3] leading-relaxed">
            ...
            and governance requirements. Scale as you grow.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 max-w-6xl mx-auto">
          ...
          <div className="border border-[#2a2a2a] rounded-2xl p-6 sm:p-8 lg:p-10 bg-[#0f0f0f] flex flex-col hover:border-[#3a3a3a] transition-all duration-300">
            ...
            <div className="mb-8">
              ...
              <p className="text-xs text-[#6b6b6b] mt-2">Free forever for core features</p>
            </div>

            <div className="mb-8">
              <h3 className="text-sm font-medium text-[#f5f5f5] mb-4">What's included:</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#1f1f1f] flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-[#a3a3a3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <span className="text-sm text-[#a3a3a3]">Visual system modeling canvas</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#1f1f1f] flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-[#a3a3a3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#a3a3a3]">Relationship & assumption modeling</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#1f1f1f] flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-[#a3a3a3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#a3a3a3]">AI-assisted evaluation (limited)</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#1f1f1f] flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-[#a3a3a3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#a3a3a3]">Single workspace</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#1f1f1f] flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-[#a3a3a3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#a3a3a3]">Standard documentation</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#1f1f1f] flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-[#a3a3a3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#a3a3a3]">Community support</span>
                </li>
              </ul>
            </div>
          ...
          <div className="border-2 border-white rounded-2xl p-6 sm:p-8 lg:p-10 bg-[#0a0a0a] flex flex-col relative hover:border-neutral-200 transition-all duration-300 shadow-lg shadow-white/5">
            ...
            <div className="flex items-start justify-between mb-6">
              <div>
                <h2 className="text-2xl sm:text-3xl font-medium mb-2">Enterprise</h2>
                <p className="text-sm sm:text-base text-[#a3a3a3]">
            ...
            <div className="mb-8">
              ...
              <p className="text-xs text-[#6b6b6b] mt-2">Contact us for pricing tailored to your needs</p>
            </div>

            <div className="mb-8">
              <h3 className="text-sm font-medium text-[#f5f5f5] mb-4">Everything in Core, plus:</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-[#f5f5f5]">Advanced AI evaluation workflows</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#f5f5f5]">Risk & trade-off analysis</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#f5f5f5]">Role-based access control (RBAC)</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#f5f5f5]">Audit logs & activity history</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#f5f5f5]">Multiple workspaces</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#f5f5f5]">Visibility & governance policies</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#f5f5f5]">Executive presentation mode</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#f5f5f5]">Priority support & dedicated success manager</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-[#f5f5f5]">SSO & advanced security</span>
                </li>
              </ul>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 border-t border-[#1f1f1f]">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-light mb-12 text-center">Frequently Asked Questions</h2>
          
          <div className="space-y-8">
            <div>
              <h3 className="text-lg font-medium mb-3">Can I upgrade or downgrade my plan?</h3>
              <p className="text-[#a3a3a3] text-sm leading-relaxed">
                Yes, you can upgrade to Enterprise at any time. Contact our sales team to discuss your needs and we'll help you transition smoothly.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-[#a3a3a3] text-sm leading-relaxed">
                We accept all major credit cards, ACH transfers, and can arrange custom invoicing for Enterprise customers with annual contracts.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-medium mb-3">Is there a free trial for Enterprise?</h3>
              <p className="text-[#a3a3a3] text-sm leading-relaxed">
                Yes, we offer a 14-day free trial of Enterprise features. Contact our sales team to get started with a demo and trial access.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-medium mb-3">What kind of support do you offer?</h3>
              <p className="text-[#a3a3a3] text-sm leading-relaxed">
                Core users have access to community support and documentation. Enterprise customers receive priority email and chat support, plus a dedicated customer success manager.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 border-t border-[#1f1f1f]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg text-[#a3a3a3] mb-8">
            Join enterprise teams using Structra.cloud to model, evaluate, and govern complex systems.
          </p>
