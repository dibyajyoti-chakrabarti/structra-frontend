...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-4 p-8">
      <h1 className="text-4xl font-bold">Hello from Login.jsx</h1>
      <div className="flex gap-4">
        ...
        <button onClick={() => navigate('/app')} className="px-4 py-2 bg-purple-500 text-white rounded">Login (Go to App)</button>
      </div>
    </div>
  );
}