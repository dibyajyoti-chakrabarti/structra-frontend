  ...
  return (
    <div className="h-full flex flex-col max-w-5xl">
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <button className="bg-white text-gray-700 border-2 border-gray-200 px-5 py-2.5 rounded-xl font-bold hover:bg-gray-50 hover:border-gray-300 transition-all flex items-center gap-2 shadow-sm">
          <Download size={18} />
          Export CSV
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
         <div className="bg-gray-50 p-5 rounded-2xl border border-gray-100">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Total Events (30d)</p>
            <p className="text-3xl font-extrabold text-gray-900">2,845</p>
         </div>
         <div className="bg-red-50 p-5 rounded-2xl border border-red-100">
            <p className="text-xs font-bold text-red-400 uppercase tracking-wider mb-1">Failed Actions</p>
            <p className="text-3xl font-extrabold text-red-900">12</p>
         </div>
         <div className="bg-blue-50 p-5 rounded-2xl border border-blue-100">
            <p className="text-xs font-bold text-blue-400 uppercase tracking-wider mb-1">Active Users</p>
      ...
      <div className="flex flex-col md:flex-row gap-3 mb-6">
        <div className="relative flex-1">
          ...
          <input 
            ...
            className="w-full pl-11 pr-4 py-3 rounded-xl border-2 border-gray-100 focus:border-blue-500 focus:ring-0 outline-none transition-all font-medium"
          />
        </div>
        <div className="relative min-w-[180px]">
           <Filter className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
           <select 
             className="w-full pl-11 pr-4 py-3 rounded-xl border-2 border-gray-100 focus:border-blue-500 outline-none font-bold text-gray-600 appearance-none bg-white cursor-pointer"
             value={filter}
      ...
      {/* Logs List Container */}
      <div className="flex-1 bg-white rounded-2xl border-2 border-gray-100 flex flex-col overflow-hidden">
